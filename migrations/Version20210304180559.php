 ...
 */
final class Version20210304180559 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__inscription AS SELECT id, id_semestre_id, nom, prenom, date_naissance, numero_etu, email, tel, adresse, date_inscription, redoublant, regime_rse, tier_temps, type_controle_choisi FROM inscription');
        ...
        $this->addSql('INSERT INTO inscription (id, id_semestre_id, nom, prenom, date_naissance, numero_etu, email, tel, adresse, date_inscription, redoublant, regime_rse, tier_temps, type_controle_choisi) SELECT id, id_semestre_id, nom, prenom, date_naissance, numero_etu, email, tel, adresse, date_inscription, redoublant, regime_rse, tier_temps, type_controle_choisi FROM __temp__inscription');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__inscription AS SELECT id, id_semestre_id, nom, prenom, date_naissance, numero_etu, email, tel, adresse, date_inscription, redoublant, regime_rse, tier_temps, type_controle_choisi FROM inscription');
        $this->addSql('DROP TABLE inscription');
        $this->addSql('CREATE TABLE inscription (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_semestre_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, date_naissance DATE NOT NULL, numero_etu INTEGER NOT NULL, email VARCHAR(255) NOT NULL, tel INTEGER NOT NULL, adresse VARCHAR(255) NOT NULL, date_inscription DATETIME NOT NULL, redoublant VARCHAR(255) NOT NULL, regime_rse VARCHAR(255) NOT NULL, tier_temps VARCHAR(255) NOT NULL, type_controle_choisi VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO inscription (id, id_semestre_id, nom, prenom, date_naissance, numero_etu, email, tel, adresse, date_inscription, redoublant, regime_rse, tier_temps, type_controle_choisi) SELECT id, id_semestre_id, nom, prenom, date_naissance, numero_etu, email, tel, adresse, date_inscription, redoublant, regime_rse, tier_temps, type_controle_choisi FROM __temp__inscription');
        $this->addSql('DROP TABLE __temp__inscription');
        $this->addSql('CREATE INDEX IDX_5E90F6D64D65622C ON inscription (id_semestre_id)');
        $this->addSql('DROP INDEX IDX_9014574A51E6528F');
