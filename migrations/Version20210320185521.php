 ...
 */
final class Version20210320185521 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__inscription AS SELECT id, id_semestre_id, id_parcours_id, nom, prenom, date_naissance, numero_etu, email, tel, adresse, redoublant, regime_rse, tier_temps, type_controle_choisi, ajac, date_inscription FROM inscription');
        $this->addSql('DROP TABLE inscription');
        $this->addSql('CREATE TABLE inscription (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_semestre_id INTEGER DEFAULT NULL, id_parcours_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, prenom VARCHAR(255) NOT NULL COLLATE BINARY, date_naissance DATE NOT NULL, numero_etu INTEGER NOT NULL, email VARCHAR(255) NOT NULL COLLATE BINARY, tel INTEGER NOT NULL, adresse VARCHAR(255) NOT NULL COLLATE BINARY, redoublant VARCHAR(255) NOT NULL COLLATE BINARY, regime_rse VARCHAR(255) NOT NULL COLLATE BINARY, tier_temps VARCHAR(255) NOT NULL COLLATE BINARY, type_controle_choisi VARCHAR(255) NOT NULL COLLATE BINARY, ajac VARCHAR(255) NOT NULL COLLATE BINARY, date_inscription DATETIME DEFAULT NULL, CONSTRAINT FK_5E90F6D64D65622C FOREIGN KEY (id_semestre_id) REFERENCES semestre (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5E90F6D6762A0D2C FOREIGN KEY (id_parcours_id) REFERENCES parcours (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO inscription (id, id_semestre_id, id_parcours_id, nom, prenom, date_naissance, numero_etu, email, tel, adresse, redoublant, regime_rse, tier_temps, type_controle_choisi, ajac, date_inscription) SELECT id, id_semestre_id, id_parcours_id, nom, prenom, date_naissance, numero_etu, email, tel, adresse, redoublant, regime_rse, tier_temps, type_controle_choisi, ajac, date_inscription FROM __temp__inscription');
