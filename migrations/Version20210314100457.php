 ...
 */
final class Version20210314100457 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE validation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, est_valide VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB NOT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__validation AS SELECT id, est_valide, description FROM validation');
        $this->addSql('DROP TABLE validation');
        $this->addSql('CREATE TABLE validation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, est_valide VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO validation (id, est_valide, description) SELECT id, est_valide, description FROM __temp__validation');
        $this->addSql('DROP TABLE __temp__validation');
    }
}
