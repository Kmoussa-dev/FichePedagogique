 ...
 */
final class Version20210314095333 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__inscription AS SELECT id, id_semestre_id, id_parcours_id, nom, prenom, date_naissance, numero_etu, email, tel, adresse, date_inscription, redoublant, regime_rse, tier_temps, type_controle_choisi, ajac FROM inscription');
        $this->addSql('DROP TABLE inscription');
        $this->addSql('CREATE TABLE inscription (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_semestre_id INTEGER DEFAULT NULL, id_parcours_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, prenom VARCHAR(255) NOT NULL COLLATE BINARY, date_naissance DATE NOT NULL, numero_etu INTEGER NOT NULL, email VARCHAR(255) NOT NULL COLLATE BINARY, tel INTEGER NOT NULL, adresse VARCHAR(255) NOT NULL COLLATE BINARY, date_inscription DATETIME NOT NULL, redoublant VARCHAR(255) NOT NULL COLLATE BINARY, regime_rse VARCHAR(255) NOT NULL COLLATE BINARY, tier_temps VARCHAR(255) NOT NULL COLLATE BINARY, type_controle_choisi VARCHAR(255) NOT NULL COLLATE BINARY, ajac VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_5E90F6D64D65622C FOREIGN KEY (id_semestre_id) REFERENCES semestre (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5E90F6D6762A0D2C FOREIGN KEY (id_parcours_id) REFERENCES parcours (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO inscription (id, id_semestre_id, id_parcours_id, nom, prenom, date_naissance, numero_etu, email, tel, adresse, date_inscription, redoublant, regime_rse, tier_temps, type_controle_choisi, ajac) SELECT id, id_semestre_id, id_parcours_id, nom, prenom, date_naissance, numero_etu, email, tel, adresse, date_inscription, redoublant, regime_rse, tier_temps, type_controle_choisi, ajac FROM __temp__inscription');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__validation AS SELECT id, est_valide, description FROM validation');
        $this->addSql('DROP TABLE validation');
        $this->addSql('CREATE TABLE validation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, est_valide VARCHAR(255) NOT NULL COLLATE BINARY, description VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO validation (id, est_valide, description) SELECT id, est_valide, description FROM __temp__validation');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__inscription AS SELECT id, id_semestre_id, id_parcours_id, nom, prenom, date_naissance, numero_etu, email, tel, adresse, date_inscription, redoublant, regime_rse, tier_temps, type_controle_choisi, ajac FROM inscription');
        $this->addSql('DROP TABLE inscription');
        $this->addSql('CREATE TABLE inscription (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_semestre_id INTEGER DEFAULT NULL, id_parcours_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, date_naissance DATE NOT NULL, numero_etu INTEGER NOT NULL, email VARCHAR(255) NOT NULL, tel INTEGER NOT NULL, adresse VARCHAR(255) NOT NULL, date_inscription DATETIME NOT NULL, redoublant VARCHAR(255) NOT NULL, regime_rse VARCHAR(255) NOT NULL, tier_temps VARCHAR(255) NOT NULL, type_controle_choisi VARCHAR(255) NOT NULL, ajac VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO inscription (id, id_semestre_id, id_parcours_id, nom, prenom, date_naissance, numero_etu, email, tel, adresse, date_inscription, redoublant, regime_rse, tier_temps, type_controle_choisi, ajac) SELECT id, id_semestre_id, id_parcours_id, nom, prenom, date_naissance, numero_etu, email, tel, adresse, date_inscription, redoublant, regime_rse, tier_temps, type_controle_choisi, ajac FROM __temp__inscription');
        $this->addSql('DROP TABLE __temp__inscription');
        $this->addSql('CREATE INDEX IDX_5E90F6D64D65622C ON inscription (id_semestre_id)');
        $this->addSql('CREATE INDEX IDX_5E90F6D6762A0D2C ON inscription (id_parcours_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__validation AS SELECT id, est_valide, description FROM validation');
        $this->addSql('DROP TABLE validation');
        $this->addSql('CREATE TABLE validation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, est_valide VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO validation (id, est_valide, description) SELECT id, est_valide, description FROM __temp__validation');
        $this->addSql('DROP TABLE __temp__validation');
    }
}
